...
- [ ] добавление (add – одна функция с разным набором аргументов): вершины, ребра, дуги;

- [ ] удаление (remove – одна функция с разным набором аргументов): вершины, ребра, дуги;

- [ ] вывод списка дуг, исходящих из вершины;
...
- [ ] перегрузка операции << – вывод графа, в удобном для чтения виде;
